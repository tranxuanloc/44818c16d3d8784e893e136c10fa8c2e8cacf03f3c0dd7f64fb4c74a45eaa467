...
public class OrderDetailWithMDKActivity extends OrderDetailActivity implements Scanner.DataListener, Scanner.StatusListener {
    public static final String TAG = OrderDetailWithMDKActivity.class.getSimpleName();
    ...
    private class AsyncEMDK extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void aVoid) {
            EMDKResults results = EMDKManager.getEMDKManager(OrderDetailWithMDKActivity.this, new EMDKManager.EMDKListener() {
                @Override
                public void onOpened(EMDKManager emdkManager) {
                    OrderDetailWithMDKActivity.this.emdkManager = emdkManager;
                    barcodeManager = (BarcodeManager) emdkManager.getInstance(EMDKManager.FEATURE_TYPE.BARCODE);
                    initScanner();
                    setTrigger();
                    setDecoders();
