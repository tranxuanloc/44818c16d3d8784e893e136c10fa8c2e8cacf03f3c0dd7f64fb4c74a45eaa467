...
public class KiemVeSinhEMDKActivity extends KiemVeSinhActivity implements Scanner.DataListener, Scanner.StatusListener {
    public static final String TAG = KiemVeSinhEMDKActivity.class.getSimpleName();
    ...
    private class AsyncEMDK extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void aVoid) {
            EMDKResults results = EMDKManager.getEMDKManager(KiemVeSinhEMDKActivity.this, new EMDKManager.EMDKListener() {
                @Override
                public void onOpened(EMDKManager emdkManager) {
                    KiemVeSinhEMDKActivity.this.emdkManager = emdkManager;
                    barcodeManager = (BarcodeManager) emdkManager.getInstance(EMDKManager.FEATURE_TYPE.BARCODE);
                    initScanner();
                    setTrigger();
                    setDecoders();
